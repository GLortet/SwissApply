...
export interface SourceRef { documentId:string; name:string; location:string; section:string; quote:string }
export interface ExtractionMetadata { method:"DETERMINISTIC"|"OPENAI"; model?:string; promptVersion:string; analyzedAt:string }
...
export interface CandidateFact {
  ...
  allowedAlternatives:string[]; tags:string[]; privateNotes?:string; active:boolean; origin:"AUTOMATIC"|"MANUAL"; extraction?:ExtractionMetadata; history:FactEvent[];
}
